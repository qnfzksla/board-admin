...
class AdminAccountServiceTest {
    ...
    @Test
    void givenNothing_whenSelectingUsersAdminAccounts_thenReturnsAllAdminAccounts(){
        ...
        BDDMockito.then(adminAccountRepository).should().findAll();
