...
class AdminAccountControllerTest {
    ...
    void givenAuthorizedUser_whenRequestingAdminMembers_thenReturnsAdminMembers() throws Exception {
        ...
        BDDMockito.then(adminAccountService).should().users();
    }
    ...
    void givenAuthorizedUser_whenDeletingAdminMember_thenDeletesAdminMember() throws Exception {
        // Given
        String username = "uno";
        BDDMockito.willDoNothing().given(adminAccountService).deleteUser(username);
        ...
        BDDMockito.then(adminAccountService).should().deleteUser(username);
    }
