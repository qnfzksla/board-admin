package com.qnfzksla.projectboardadmin.domain;

import com.qnfzksla.projectboardadmin.domain.constant.RoleType;
import com.qnfzksla.projectboardadmin.domain.converter.RoleTypesConverter;
...
public class UserAccount extends AuditingFields {
    ...
    @Convert(converter = RoleTypesConverter.class) @Column(nullable = false)
